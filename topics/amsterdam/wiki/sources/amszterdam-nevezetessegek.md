...
**Source:** Hungarian comprehensive city guide
**Language:** Hungarian
**Content length:** 66,733 characters (largest source in collection)

## Summary

An extremely detailed and up-to-date (2026) Hungarian-language guide to Amsterdam's sights, museums, and practical visitor information. This is the single most comprehensive source in the collection, covering major landmarks, museums, cultural districts, transport, and accommodation areas in substantial depth. Entry prices are current as of 2026.
...
- **Het Scheepvaartmuseum (Maritime Museum)** - entry EUR 20
- **Rembrandthuis (Rembrandt House Museum)** - entry EUR 23.50
- **Verzetsmuseum (Dutch Resistance Museum)** - WWII resistance history
...
## Practical Information Covered

- **Transport:** Detailed information on tram and bus routes within Amsterdam
- **Accommodation:** Overview of recommended areas/neighborhoods for staying

## Key Takeaways

- Most comprehensive single source for Amsterdam sights with 2026-current pricing
- Anne Frank House requires advance online ticket purchase (no walk-ups)
- Museum prices range from EUR 13.50 (Royal Palace) to EUR 25 (Rijksmuseum, Van Gogh)
- The Canal Ring's UNESCO status makes it a must-see beyond individual attractions
- Detailed enough to serve as a primary reference for museum and landmark pages

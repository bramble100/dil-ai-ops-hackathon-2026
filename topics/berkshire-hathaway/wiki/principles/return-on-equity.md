...
Return on beginning equity capital (with securities valued at cost) is the correct measure of single-year managerial economic performance. Not earnings per share. Not revenue growth. Not size. The distinction matters because EPS rises automatically when earnings are retained — even a dormant savings account "grows."

## Buffett's Teaching

> "Most companies define 'record' earnings as a new high in earnings per share. Since businesses customarily add from year to year to their equity base, we find nothing particularly noteworthy in a management performance combining, say, a 10% increase in equity capital and a 5% increase in earnings per share." — 1977 Letter
...
**Short-term vs. long-term metrics:** Buffett uses ROE on beginning equity (securities at cost) for single-year performance, but for long-term evaluation he includes all capital gains, realized and unrealized, with securities at market value[^1].

## Evolution

The metric is introduced in the very first letter (1977) and stated with increasing force through 1981. As Berkshire's equity base grows, Buffett repeatedly warns that the ROE percentage will decline — from 19% (1977) to 19.4% (1978) to 18.6% (1979) to 17.8% (1980) to 15.2% (1981) — even as dollar earnings rise.

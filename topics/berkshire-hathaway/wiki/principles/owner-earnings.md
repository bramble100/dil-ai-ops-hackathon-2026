...
Owner earnings are the total economic earnings attributable to a shareholder, including the proportional share of retained earnings from non-controlled investees — regardless of whether GAAP accounting recognizes them. The value of an investment is determined by the earnings it generates and how those earnings are deployed, not by accounting conventions about consolidation thresholds.
...
- [Four Filters](four-filters.md) — filter (3), honest/competent management, matters most when earnings are retained and reinvested by others
- [Capital Allocation](capital-allocation.md) — the value of retained earnings depends entirely on how they're deployed
- [GEICO Investment](../case-studies/geico-investment.md) — the supreme example: $47M cost, $20M annual earning power, only ~$3M in dividends reported

[^1]: [1980 Letter](../sources/buffett-letter-1980.md) — three-tier accounting explanation

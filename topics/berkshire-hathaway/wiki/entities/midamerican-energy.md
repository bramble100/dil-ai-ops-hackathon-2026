...
MidAmerican Energy Holdings Company is a regulated electric utility acquired by Berkshire Hathaway in 1999 for approximately $2B. It was Berkshire's first major utility investment and marked the beginning of a significant capital allocation category. Due to the Public Utility Holding Company Act of 1935 (PUHCA), Berkshire's voting power is constrained to less than 10% of the utility's shares even though its economic interest is approximately 76%.

## Key Facts

- **Acquired:** 1999
- **Consideration:** ~$2B (mix of 11% fixed income securities and equity)
- **Economic interest:** ~76% (majority economic ownership)
- **Voting interest:** <10% (constrained by PUHCA 1935 which limits utility holding company voting concentration)
- **CEO:** David Sokol (named CEO at acquisition; later became a leading candidate to succeed Buffett before his departure from Berkshire in 2011)
- **Facilitator:** Walter Scott Jr. (longtime Buffett friend and board member; introduced the opportunity)
- **Business:** Regulated electric and gas utility serving Iowa and surrounding states; predictable cash flows from rate-regulated operations

## Investment Rationale

MidAmerican represented a large-capital deployment opportunity in a business with predictable, regulated economics. Buffett was attracted to utilities because:

1. Regulated returns are predictable even if not spectacular
2. The capital base is enormous — utilities can absorb billions of Berkshire's retained earnings
3. The regulatory framework creates an effective moat: competitors cannot enter without regulatory approval

The PUHCA voting constraint was not a deterrent — Berkshire's economic ownership is what matters, and the regulatory structure governing utilities provides governance protections that substitute for voting control.

## 2000-2001 Operations

**[2000 Letter]** MidAmerican closes (acquisition was agreed 1999, completed 2000). Due to PUHCA regulatory constraints, Berkshire performs only a "one-line" consolidation — if fully consolidated, Berkshire's 2000 revenues would have been $5B greater (though net income unchanged). Pre-tax earnings: $197M (2000).

**[2001 Letter]** Strong year: pre-tax earnings $600M (vs. $197M in 2000, which was a partial year). MidAmerican swapped some English properties for Yorkshire Electric (2.1 million customers). Now serving **3.6 million customers in the UK** — the 2nd largest electric utility in the UK. Also has significant operations in Iowa and major generating facilities in California and the Philippines.

Hidden asset: MidAmerican also owns the **2nd-largest residential real estate brokerage in the US** (built by Ron Peltier). Market-share leaders in multiple large Midwest cities; recently acquired firms in Atlanta and Southern California. Handled ~106,000 transactions worth ~$20B in properties annually in 2001.

Goodwill amortization charge will disappear under SFAS 142 (new GAAP rule eliminating mandatory goodwill amortization), which will significantly increase MidAmerican's reported earnings.

## 2002: Pipeline Empire

**[2002 Letter]** MEHC acquires two major gas pipelines, transforming from a regional utility into a national energy infrastructure company:

- **Kern River Gas Transmission:** $1.2B expansion approved to double throughput — will carry gas from Southwest Wyoming to Southern California
- **Northern Natural Gas:** 16,600 miles of pipeline recovered from the Enron/Dynegy collapse. Dynegy had agreed to acquire the pipeline but couldn't close; Berkshire paid ~$1B for an asset that "would very probably have been lost" to Dynegy's creditors
- After Kern River expansion completes, MEHC will carry **~8% of all US natural gas**
- HomeServices of America: 2nd-largest residential brokerage, **$37B in transactions** (up 100% from prior year), Ron Peltier CEO
- Dave Sokol and Greg Abel are "huge assets for Berkshire" [^5]

## 2003: Major Energy Platform

**[2003 Letter]** Pre-tax earnings reach $1.076B (up from $790M). MEHC has become a major Berkshire earnings contributor:

- Pipelines now carry **7.8% of US natural gas**
- UK utilities: 3.7 million customers (#3 UK electricity distributor). Since denationalization in 1990: employees reduced from 6,800 to 2,539 while serving same customers and delivering more electricity — "a victory for those who believe that profit-motivated managers will find efficiencies that government never will"
- HomeServices: **$48.6B in transactions** (up from $37B), 16 brokerage firms, 16,343 brokers, 16 states
...
- [2000 Letter](../sources/buffett-letter-2000.md) — acquisition closes; one-line consolidation; $5B revenue off-balance-sheet; $197M pre-tax earnings
- [2001 Letter](../sources/buffett-letter-2001.md) — $600M pre-tax earnings; Yorkshire Electric acquisition → 3.6M UK customers, #2 UK electric utility; 2nd-largest US residential real estate brokerage; SFAS 142 goodwill benefit
...
### 2024-2025: 100% Ownership, Recovery, and AI Demand

**[2024 Letter]** BHE earns **$3,730M** (up from $2,331M in the wildfire-crisis year). Berkshire increases ownership from ~92% to **100%** at a cost of ~$3.9B ($2.9B cash + Berkshire B shares)[^22].

**[2025 Letter]** BHE generates **$8.4B net operating cash flows** (consistent with 5-year avg, even absorbing wildfire challenges). Customer rates average **24% below national retail electric rate level** — all markets double-digit below benchmark.

**AI/data center demand:** "Rising electricity demand from artificial intelligence computing" drives a significant investment cycle. But Abel is disciplined: "Infrastructure built for hyperscalers and data centers must be paid for by those customers and reflect the risks tied to step-changes in long-term demand." BHE will invest "only when those risks and rewards are appropriately balanced."

**Wildfire resolution progress:** "Taken a leadership role, working with regulators, public officials, and the communities it serves." PacifiCorp has settled claims related primarily to the 2020 Labor Day fires while maintaining principled opposition to unwarranted liability. "Accountability, paired with principled opposition to unwarranted liability, is essential to preserving the regulatory compact."

BHE is "rebalancing as the team positions it to move forward" — near-term opportunities significant, pursued selectively[^23].

[^22]: [2024 Letter](../sources/buffett-letter-2024.md) — $3,730M (recovery from wildfire year); 100% ownership at ~$3.9B

[^23]: [2025 Letter](../sources/buffett-letter-2025.md) — $8.4B operating cash; 24% below national rate; AI/data center demand; wildfire leadership; PacifiCorp settlements; regulatory compact; rebalancing
